        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <div className="flex gap-3 mt-5">
              ...
              <a href="#" aria-label="Bright Broom Service on Instagram" className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-teal-brand transition-colors">
